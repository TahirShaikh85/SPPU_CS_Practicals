...
# |   Difference     | Kattar elements(other than commons)  |
# |   Union          |      All elements of both sets       |
# |   Symm_diff      | Difference of both sets and union    |
# ------------------------------------------------------------


# ------------------------------------------------------------
# |      CB          |    intersection(lst1,lst2)           |
# |   eCoB_notBoth   |    sym_diff(lst1, lst2)              |
# |     nCnB         |     diff(lst1, union(lst2, lst3))    |
# |     CFnB         | diff(intersection(lst1, lst2), lst3) |
# ------------------------------------------------------------
...
def intersection(lst1, lst2):  # common elements of two sets
    lst3 = []
    for val in lst1:
        if val in lst2:
            lst3.append(val)
...
def union(lst1, lst2):  # all elements of both sets
    lst3 = lst1.copy()
    for val in lst2:
        if val not in lst3:
            lst3.append(val)
...
def diff(lst1, lst2):  # neglect common elements (kattar samarthak)
    lst3 = []
    for val in lst1:
        if val not in lst2:
            lst3.append(val)
...
def sym_diff(lst1, lst2):  # difference of two sets and then uion of that set
    lst3 = []
    D1 = diff(lst1, lst2)
...
print("Enter the names of", n,
      "students (Please press ENTER after entering each students name) :")
for i in range(0, n):
    ele = input()
...
print("Enter the names of", n,
      "students who play cricket (Please press ENTER after entering each students name) :")
for i in range(0, n):
    ele = input()
...
print("Enter the name of", n,
      "students who play football (Please press ENTER after entering each students name) :")
for i in range(0, n):
    ele = input()
...
print("Enter the name of", n,
      "students who play badminton (Please press ENTER after entering each students name) :")
for i in range(0, n):
    ele = input()
...
while flag == 1:
    ...
    if ch == 1:
        ...
        print("Number of students who play either cricket or badminton but not both : ", eCeB(
            Cricket, Badminton))
        a = input("\n\nDo you want to continue (yes/no) :")
        if a == "yes":
            flag = 1
        ...
        print("Number of students who play neither cricket nor badminton : ", nCnB(
            SEComp, Cricket, Badminton))
        a = input("\n\nDo you want to continue (yes/no) :")
        if a == "yes":
            flag = 1
        else:
        ...
        print("Number of students who play cricket and football but not badminton : ", CBnF(
